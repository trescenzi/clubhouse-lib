...
export declare type StoryHistoryAction = {
    id: ID;
    entity_type: string;
    action: string;
    app_url: string;
...
export declare type StoryHistoryReference = {
    id: ID;
    entity_type: string;
    name: string;
    type: IterationStatus;
};
export declare type StoryHistory = {
...
export declare type StoryHistories = Array<StoryHistory>;
